(function (ns) {
    ...
    Base.extend(SnippetConnector.prototype, {
        execute: function(snippetList, mode){
            ...
            if(context.mode == SNIPPED_CONVERTER_MODE.GLSL_VS){
    ...
    function getParamAccessAst(ast, arrayAccess, iterate, context){
        if(context.mode == SNIPPED_CONVERTER_MODE.JS_ITERATE && !arrayAccess){
        ...
        else if(context.mode == SNIPPED_CONVERTER_MODE.GLSL_VS){
